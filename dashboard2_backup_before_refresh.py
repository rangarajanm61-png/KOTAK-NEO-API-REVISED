...
if "CE Delta" not in option_df.columns:
    option_df["CE Delta"] = "NA"

if "CE Theta" not in option_df.columns:
    option_df["CE Theta"] = "NA"

if "PE Delta" not in option_df.columns:
    option_df["PE Delta"] = "NA"

if "PE Theta" not in option_df.columns:
    option_df["PE Theta"] = "NA"
...
st.subheader("Table 1 - Option Chain with Greeks")
