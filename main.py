...
while True:
    ...
    # Read latest live NIFTY spot just before creating summary
    try:
        with open("nifty_spot_live.txt", "r") as f:
            latest_spot = float(f.read().strip())

        option_chain["Spot"] = latest_spot
        print(f"FINAL LIVE SPOT = {latest_spot}")
